...
3. If the user provided an argument, create a feature branch following the project's branch naming convention and begin working on it immediately — treat the argument as the task description.
